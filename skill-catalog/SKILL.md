...
the selected skill requires them. For ambiguous tasks, add
`--backend opencode`. The local selector is the default because it is free,
private, and fast; OpenCode is an optional fallback.
